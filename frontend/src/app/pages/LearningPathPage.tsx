...
const modules: Module[] = [
  {
    ...
    description: "Learn the building blocks of web pages — tags, attributes, forms, and semantic markup.",
    icon: Code,
    status: "completed",
    progress: 100,
    totalTime: "3.5 hrs",
  ...
  },
  {
    ...
    description: "Master styling with selectors, layouts, Flexbox, Grid, and responsive design.",
    icon: Palette,
    status: "in-progress",
    progress: 65,
    totalTime: "5 hrs",
    xp: 600,
    lessons: [
      { title: "CSS Selectors & Specificity", duration: "20 min", type: "video" },
  ...
  },
  {
    ...
    description: "Understand variables, functions, DOM manipulation, events, and async patterns.",
    icon: FileText,
    status: "not-started",
    progress: 0,
    totalTime: "8 hrs",
  ...
  },
  {
    id: "react",
    title: "React Basics",
    description: "Components, JSX, state, props, hooks, and building interactive UIs.",
    icon: Layers,
    status: "locked",
    progress: 0,
    totalTime: "10 hrs",
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-4 md:gap-6">
        ...
        {/* Card */}
        <motion.div
          whileHover={isLocked ? {} : { y: -2, boxShadow: "0 8px 30px rgba(0,0,0,0.08)" }}
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-start gap-4 flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-gray-500 mb-3" style={{ fontSize: "0.8125rem", lineHeight: 1.5 }}>
                    {module.description}
                  </p>
                  ...
                  {module.progress > 0 && (
                    <div className="flex items-center gap-3 mt-3">
                      <ProgressBar
                        ...
                        color={module.status === "completed" ? "bg-green-500" : "bg-blue-500"}
                      />
              ...
              <div className="p-5 md:p-6 pt-4 space-y-2">
                {module.lessons.map((lesson, li) => {
                  ...
                  const isCompleted =
                    module.status === "completed" ||
                    (module.status === "in-progress" &&
                      li < Math.floor((module.progress / 100) * module.lessons.length));
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-gray-400 shrink-0" style={{ fontSize: "0.6875rem" }}>
                        {lesson.duration}
                      </span>
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-indigo-200 mb-5" style={{ fontSize: "0.875rem" }}>
          4 modules &middot; 26.5 hours &middot; 2,850 XP total
        </p>
        <div className="flex items-center gap-3">
          ...
          <span style={{ fontSize: "0.875rem", fontWeight: 700 }}>{totalProgress}%</span>
        </div>
      </motion.div>
